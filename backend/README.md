...
## Project Structure
    ...
    ├── testapiautodatamod_121524  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_121524`
...
2. Clone this repo and `cd testapiautodatamod_121524`
